...
class City(models.Model):
    ...
    name_ua = models.CharField(max_length=255, blank=True, default="", verbose_name="Назва українською")
    ...
    api_id = models.PositiveIntegerField(null=True, blank=True, unique=True, verbose_name="ID в Geo API")
